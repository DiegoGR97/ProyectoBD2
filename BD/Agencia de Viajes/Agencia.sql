...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "DIEGO"."USUARIOS_AGENCIA_PK" ON "DIEGO"."USUARIOS_AGENCIA" ("ID_USUARIO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "DIEGO"."USUARIOS_AGENCIA" MODIFY ("ID_USUARIO" NOT NULL ENABLE);
  ...
  ALTER TABLE "DIEGO"."USUARIOS_AGENCIA" ADD CONSTRAINT "USUARIOS_AGENCIA_PK" PRIMARY KEY ("ID_USUARIO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
