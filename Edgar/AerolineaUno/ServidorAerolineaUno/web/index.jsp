            ...
            <div class="container">
                ...
                <div>
                    <ul class="nav navbar-nav">
                        ...
                        <li><a  href="../ServidorAerolineaUno/operaciones/cancelarBoleto.jsp">Cancelar Boleto</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="container">
                                        ...
                                        <form action="../ServidorAerolineaUno/servlets/insertBoleto.jsp" method="post" class="form-signin">
