 ...
 * 
 */
@WebService(name = "OperacionesAerolineaDos", targetNamespace = "http://ws.org/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface OperacionesAerolineaDos {
    ...
    @Action(input = "http://ws.org/OperacionesAerolineaDos/getCertainVuelosRequest", output = "http://ws.org/OperacionesAerolineaDos/getCertainVuelosResponse")
    ...
    @Action(input = "http://ws.org/OperacionesAerolineaDos/comprarBoletoAgenciaUnoRequest", output = "http://ws.org/OperacionesAerolineaDos/comprarBoletoAgenciaUnoResponse")
    ...
    @Action(input = "http://ws.org/OperacionesAerolineaDos/getVuelosRequest", output = "http://ws.org/OperacionesAerolineaDos/getVuelosResponse")
    ...
    @Action(input = "http://ws.org/OperacionesAerolineaDos/getClientesRequest", output = "http://ws.org/OperacionesAerolineaDos/getClientesResponse")
    ...
    @Action(input = "http://ws.org/OperacionesAerolineaDos/nuevoClienteRequest", output = "http://ws.org/OperacionesAerolineaDos/nuevoClienteResponse")
    ...
    @Action(input = "http://ws.org/OperacionesAerolineaDos/cancelarBoletoRequest", output = "http://ws.org/OperacionesAerolineaDos/cancelarBoletoResponse")
    ...
    @Action(input = "http://ws.org/OperacionesAerolineaDos/getOrigenDestinoRequest", output = "http://ws.org/OperacionesAerolineaDos/getOrigenDestinoResponse")
